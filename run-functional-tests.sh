...
containers=("liferay-sample-etc-spring-boot-container" "liferay-sample-etc-node-container" "liferay-workspace-testing-liferay")
...
echo "Running functional tests: ${setupProfile}..."
